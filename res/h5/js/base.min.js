...
cp2y.util = {
	...
	splitNumber1: function(s) {
		try {
			return "<em>" + s.split(",").join("</em><em>") + "</em>"
		} catch (e) {}
	},
	splitNumber2: function(s) {
		try {
			var s1 = s.split("#"),
				s2 = s1[0].split(",");
			return "<em>" + s2.join("</em><em>") + "</em><b>" + s1[1].split(",").join("</b><b>") + "</b>"
		} catch (e) {}
	},
...
$.extend(Array.prototype, {
	...
	del: function(value, isPos) {
		var pos = !isPos ? this.indexOf(value) : value;
		if (pos == -1) return;
		this.splice(pos, 1);
		return this
	},
...
$.extend(String.prototype, {
	toArray: function(s) {
		if (s) return this.split(s);
		var arr = [];
		for (var i = 0; i < this.length; i++) arr.push(this.substring(i, i + 1));
		return arr
	},
	isID: function() {
